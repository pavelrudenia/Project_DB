package rudenia.fit.bstu.projectbd.view
...
import kotlinx.android.synthetic.main.activity_apimain.*
import rudenia.fit.bstu.projectbd.R
import rudenia.fit.bstu.projectbd.viewmodel.MainViewModel
import kotlinx.android.synthetic.main.activity_main.*

private const val TAG = "APIMainActivity"
...
class MainActivityAPI : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var cName = GET.getString("cityName", "minsk")?.toLowerCase()
